...
exports.Herod = ( function () {
    ...
    var instance = null,
        ...
        Herod = function () {
            ...
            me.lsignal = null;
            /*
             * genocide killback ( callback ), it defaults to emptyFn.
             * It is called after that every child process will be exited.
             * Note that it will be resetted after every genocide call.
             */
            me.gkback = emptyFn;
            // main process killback, called on main process 'exit' event.
            me.mkback = emptyFn;
            /*
    ...
    pproto.suicide = function ( signal, callback ) {
        var me = this,
            cback = ( typeof callback === 'function' ) ? callback : emptyFn,
            bye = function () {
                me.log( '- info: now call "exit()" for main process "%s", pid: "%s"', process.title, process.pid );
                process.exit();
            };
        ...
        // set main process killback
        me.mkback = cback;
        if ( me.alive ) {
            // kill alive child processes
